...
import com.campusdigitalfp.filmotecav2.common.VideoItem // Importa VideoItem


@Composable
fun AboutScreen(navController: NavHostController, viewModel: FilmViewModel, authViewModel: AuthViewModel) {
    ...
    Scaffold(modifier = Modifier.fillMaxSize(),
        ...
        Column(
            ...
            // Video
            VideoItem(videoUrl = "https://www.youtube.com/watch?v=EF889gHjZu8")

            // Botones para el sitio web y soporte
            Row(
                modifier = Modifier
                    .fillMaxWidth()
                    .padding(5.dp),
